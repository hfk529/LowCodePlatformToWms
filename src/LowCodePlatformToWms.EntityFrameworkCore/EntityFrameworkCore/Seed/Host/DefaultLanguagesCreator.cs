...
namespace LowCodePlatformToWms.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LowCodePlatformToWmsConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LowCodePlatformToWmsDbContext context)
        {
            _context = context;
        }
