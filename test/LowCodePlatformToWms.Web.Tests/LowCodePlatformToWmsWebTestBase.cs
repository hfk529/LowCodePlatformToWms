...
{
    public abstract class LowCodePlatformToWmsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LowCodePlatformToWmsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LowCodePlatformToWmsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LowCodePlatformToWmsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LowCodePlatformToWmsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LowCodePlatformToWmsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LowCodePlatformToWmsDbContext, Task<T>> func)
        {
            T result;
